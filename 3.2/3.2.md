...
```
Прежде чем перейти к установке зависимостей поправим файл requirements.txt, в моём случае там была указана некорректная версия ansible.  
Указал версию 5.7.1  
...
Это ручной способ, далее представлен автоматический.  
```
