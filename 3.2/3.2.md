...
# Ожидание получения IP-адреса мастерноды


# Создание рабочей ноды 1 и получение ее IP-адреса
...
# Ожидание получения IP-адреса рабочей ноды 1


# Создание рабочей ноды 2 и получение ее IP-адреса
...
# Ожидание получения IP-адреса рабочей ноды 2


# Создание рабочей ноды 3 и получение ее IP-адреса
...
# Ожидание получения IP-адреса рабочей ноды 3

# Создание рабочей ноды 4 и получение ее IP-адреса
...
```
scp -i /home/igor/.ssh/id_rsa yc-user@51.250.75.58:~/.ssh/
```
...
```
Прежде чем перейти к установке зависимостей поправим файл requirements.txt.  
Во время выполнения ДЗ обнаружил, что он был изменён буквально на днях, и теперь там указаны версии пакетов, которых ещё нет в зеркалах яндекса.
```
sudo nano requirements.txt
```
Привёл его к следующему виду
```
ansible==5.7.1
...
```
Установим зависимости на том же устройстве
```
