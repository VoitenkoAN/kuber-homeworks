...
netology-deployment-front   3/3     3            3           5m38s
netology-deployment-back    3/3     3            3           5m34s
```
```
...
netology-svc-front-back   ClusterIP   10.152.183.147   <none>        80/TCP,8080/TCP   6m31s
```
