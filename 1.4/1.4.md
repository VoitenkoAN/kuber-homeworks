...
```
При обращению к сервису **netology-svc-external** по нодпорту 30001 будет проброс на порт службы 9001, которая в свою очередь сделает проброс к приложению на порт 80.  Нодпорт будет выбран автоматически из диапозона 30000 - 32767 если мы не укажем его сами.  
