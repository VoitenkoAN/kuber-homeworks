...
/var/snap/microk8s/current/credentials$ ls
client.config 
...
```
Если бы мы работали в полноценном кубере, мы могли бы создать контекст пользователя.  
Так как я работаю в microk8s этот шаг можно пропустить.  
